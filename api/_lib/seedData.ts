...
export const FREE_CASE = {
    ...
    intro: `O Teatro Aurora completa 100 anos, e boa parte da segunda metade dessa história tem a marca de Otávio Reis, que reergueu a casa da falência há mais de três décadas. Nos primeiros anos, teve uma parceira criativa e esposa, Beatriz Lemos — juntos escreveram o maior sucesso da carreira de Otávio, mas, como era comum na época, só o nome dele foi pros créditos e pro registro de direitos autorais. O casamento não resistiu a outras questões anos depois, mas Beatriz nunca deixou o teatro: hoje é a figurinista-chefe da casa, e o ressentimento antigo por nunca ter sido reconhecida como coautora ficou ali, quieto, por décadas.

Pra celebrar o centenário, Otávio apostou tudo numa peça original escrita ao lado de seu pupilo, o jovem dramaturgo Rafael Konrad — um investimento caro, bancado majoritariamente pelo patrono Eduardo Bittencourt, que vinha pressionando por mudanças na gestão criativa da casa em troca de manter o financiamento. A produtora executiva Marcela Andrade cuidava do orçamento apertado da montagem; a atriz principal, veterana Isadora Vasconcelos, temia perder espaço pra uma atriz mais jovem que Otávio vinha claramente favorecendo nos ensaios; e Bento Salgado, assistente de direção há 20 anos, tinha acabado de saber que não seria ele o escolhido pra dirigir o próximo grande espetáculo da casa — a oportunidade fora dada a um nome de fora.

Horas antes da estreia, dois problemas estouraram ao mesmo tempo. Primeiro, Bento descobriu, checando notas fiscais de cenário e figurino pro fechamento do orçamento, contratos com fornecedores que não existiam — e avisou Otávio, sem saber ainda quem estava por trás. Segundo, e mais grave pra Otávio pessoalmente: um pesquisador contratado pra montar a retrospectiva de 100 anos encontrou rascunhos antigos provando que o maior sucesso da carreira de Otávio tinha sido, na verdade, coescrito por Beatriz — achado que seria parte da exposição comemorativa naquela mesma noite. Otávio, em pânico com a própria reputação às vésperas da estreia mais importante da vida, decidiu negar tudo caso alguém perguntasse, e avisou Beatriz pessoalmente, nos bastidores, que "não tinha como reconhecer isso agora, não daquele jeito, na frente de todo mundo" — a mesma promessa quebrada mais uma vez, depois de décadas de espera. Por volta das 19h50, durante a recepção de pré-estreia no saguão, os dois ficaram sozinhos por alguns minutos na sala de figurino e adereços, combinando um registro fotográfico com o troféu de fundação do teatro pra exposição — e foi lá que Otávio foi encontrado morto, pouco antes da abertura das cortinas.`,
    timeline: [
        'Há 35 anos — Otávio e Beatriz coescrevem o maior sucesso da carreira dele; só o nome dele vai pros créditos.',
        ...
        'Há 2 semanas — o pesquisador da retrospectiva encontra os rascunhos que provam a coautoria de Beatriz.',
